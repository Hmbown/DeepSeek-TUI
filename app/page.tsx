...
const MODEL_OPTIONS = ["wagmii-reasoner", "wagmii-chat"];
...
export default function Home() {
  ...
  const [model, setModel] = useState("wagmii-reasoner");
  ...
  const handleCompactThread = useCallback(async () => {
    ...
    try {
      await compactThread(baseUrl, selectedThreadId, { reason: "Manual compact from Wagmii App" });
