...
impl Default for CapacityControllerConfig {
    fn default() -> Self {
        ...
        model_priors.insert("wagmii_v3_2_chat".to_string(), 3.9);
        model_priors.insert("wagmii_v3_2_reasoner".to_string(), 4.1);
...
impl CapacityControllerConfig {
    ...
    pub fn from_app_config(config: &crate::config::Config) -> Self {
        ...
        if let Some(v) = capacity.wagmii_v3_2_chat_prior {
            out.model_priors.insert("wagmii_v3_2_chat".to_string(), v);
        }
        if let Some(v) = capacity.wagmii_v3_2_reasoner_prior {
            out.model_priors
                .insert("wagmii_v3_2_reasoner".to_string(), v);
        }
