...
//! # Architecture
//!
//! - `LlmClient` trait: Async interface for LLM providers (Wagmii, `OpenAI`, etc.)
...
///
/// This trait abstracts over different LLM APIs (Wagmii, `OpenAI`, etc.)
...
pub trait LlmClient: Send + Sync {
    /// Returns the provider name (e.g., "openai", "wagmii")
