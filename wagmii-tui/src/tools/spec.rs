//! Tool specification traits for the wagmii-cli agent system.
//!
...
impl ToolContext {
    ...
    pub fn new(workspace: impl Into<PathBuf>) -> Self {
        ...
        let notes_path = workspace.join(".wagmii").join("notes.md");
        let mcp_config_path = workspace.join(".wagmii").join("mcp.json");
        Self {
            workspace,
            shell_manager,
            trust_mode: false,
