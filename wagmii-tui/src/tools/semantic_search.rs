...
const DISABLE_SEMANTIC_ENV: &str = "WAGMII_DISABLE_SEMANTIC_SEARCH";
...
mod tests {
    ...
    async fn semantic_search_reports_fallback_when_disabled() {
        ...
        unsafe {
            std::env::set_var("WAGMII_DISABLE_SEMANTIC_SEARCH", "1");
        }
        ...
        unsafe {
            std::env::remove_var("WAGMII_DISABLE_SEMANTIC_SEARCH");
        }
